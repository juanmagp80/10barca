...
export default function RootLayout({ children }) {
  ...
  const isBaloncestoPage = pathname.startsWith('/baloncesto');
  const isBalonmanoPage = pathname.startsWith('/balonmano');
              ...
              <nav className={`fixed top-0 left-0 w-full p-6 z-10 transition-all duration-300 ${scrolled ? 'bg-white shadow-md text-black' : 'bg-transparent text-white'}`}>
                <div className="flex justify-between items-center mr-14">
                  ...
                  <ul className="flex space-x-6 font-dosis text-2xl items-center">
                    ...
                    <li><Link href="/primerequipo" className="hover:text-red-500 transition-colors">Noticias Primer Equipo</Link></li>
